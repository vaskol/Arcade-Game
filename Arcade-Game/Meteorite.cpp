...
void Meteorite::update()
{
	...
	rotation += 0.05f /*(ìïßñåò)*/ * graphics::getDeltaTime();
...
void Meteorite::draw()
{
	...
	if (game.getDebugMode())
	{
		...
		Disk met_disk = getCollisionHull(0.45f);			//** CHECK inheritance return type --> äéÜë.
...
{
	size = 50 + 100 * rand0to1();			//Áñ÷éêÞ èÝóç ìåôåùñßôç.
